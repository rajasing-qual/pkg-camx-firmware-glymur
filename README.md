# pkg-camx-firmware-glymur

This repository has debian packaging rules and scripts for [prebuilt CamX camera framework binaries](https://qartifactory-edge.qualcomm.com/ui/native/qsc_releases/software/chip/component/camx.qclinux.0.0/) for the Glymur platform.
...
- **qcom/ubuntu/resolute**: This branch contains camx-glymur debian packaging rules and scripts for Ubuntu 26.04 (Resolute Raccoon).
- **qcom/debian/trixie**: This branch contains camx-glymur debian packaging rules and scripts for Debian Trixie.
...
1. Install the camera glymur firmware package:
    - `sudo dpkg -i camx-firmware-glymur_<version>_arm64.deb`
...
pkg-camx-glymur is licensed under the [BSD-3-Clause license](https://spdx.org/licenses/BSD-3-Clause.html). See [LICENSE.txt](LICENSE.txt) for the full license text.
